...
class SettingsWindow:
    ...
    def setup_styles(self):
        ...
        # 基本样式
        style.configure('Settings.TFrame', background='#2B2B2B')
    ...
    def create_widgets(self):
        ...
        # 基本设置组
        basic_frame = ttk.LabelFrame(main_frame, text="基本设置", style='Settings.TLabelframe')
        ...
        for text, var, unit in settings:
            ...
            ttk.Label(frame, text=text, style='Settings.TLabel').pack(side='left')
            
            entry = ttk.Entry(frame, textvariable=var, width=8)
            entry.pack(side='right', padx=(0, 5))
            
            ttk.Label(frame, text=unit, style='Settings.TLabel').pack(side='right')

        # 颜色设置组
        color_frame = ttk.LabelFrame(main_frame, text="颜色设置", style='Settings.TLabelframe')
        color_frame.pack(fill='x', pady=(0, 10), padx=5)

        ttk.Button(color_frame, text="选择背景颜色", 
                  command=self.choose_bg_color,
                  style='Settings.TButton').pack(fill='x', padx=10, pady=5)
        
        ttk.Button(color_frame, text="选择文字颜色",
        ...
        ttk.Button(main_frame, text="保存设置",
                  ...
                  style='Settings.TButton').pack(pady=(10, 0))
