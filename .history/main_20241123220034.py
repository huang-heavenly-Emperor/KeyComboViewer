...
class SettingsWindow:
    ...
    def setup_styles(self):
        ...
        style.configure('Settings.TEntry',
            ...
            foreground='#FFFFFF',
            padding=5,
            insertcolor='white',  # 光标颜色
            selectbackground='#4B6EAF',  # 选中文本的背景色
            selectforeground='#FFFFFF'  # 选中文本的前景色
        )
    ...
    def create_widgets(self):
        ...
        for text, var, unit, tooltip in settings:
            ...
            # 创建自定义输入框
            entry = tk.Entry(  # 使用 tk.Entry 替代 ttk.Entry
                entry_frame,
                textvariable=var,
                width=10,
                font=('Segoe UI', 10),
